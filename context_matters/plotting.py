...
def plot2dvaluefn_difference(data, x, y, value_a0, value_a1, x_lab, y_lab, visit_thresh = 10, \
    title = "Optimal value function", xlim = None, ylim = None, subplots_adjust = None):
    """
